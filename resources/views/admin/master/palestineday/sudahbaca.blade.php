...
@section('content')
    <div class="iq-navbar-header">
        ...
        <div class="title my-3">
            <h1 class="text-white" style="margin-left: 1rem">List Sudah Baca Materi Palestine Day </h1>
        </div>
    </div>
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex" style="justify-content: flex-end">
                    <form action="{{route('master.export-sudahbaca')}}" method="GET" ><button class="btn btn-success btn-sm" > Export Excel </button> </form>
                </div>
