...
<div class="container text-center mt-5">
    <div class="alert alert-info" role="alert">
        ...
        <h4 class="alert-heading">Pendaftaran Trial Class Ditutup Sementara</h4>
        <p>Terima kasih atas antusiasme Ayah/Bunda terhadap program Trial Class Sekolah Rabbani.</p>
        <p>Saat ini, pendaftaran Trial Class kami tutup sementara untuk semua unit/cabang. Hal ini dilakukan agar kami dapat mempersiapkan pengalaman terbaik bagi calon peserta.</p>
        <p>Insya Allah informasi pembukaan selanjutnya akan kami umumkan melalui website resmi Sekolah Rabbani.</p>
